...
LDFLAGS := -X 'github.com/ethanefung/ehaul/internal/auth.clientID=$(GMAIL_CLIENT_ID)' \
           -X 'github.com/ethanefung/ehaul/internal/auth.clientSecret=$(GMAIL_CLIENT_SECRET)'
